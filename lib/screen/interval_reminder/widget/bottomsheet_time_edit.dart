...
class BottomsheetIntervalTimeEdit extends StatefulWidget {
  const BottomsheetIntervalTimeEdit(
      {super.key,
  ...
  @override
  State<BottomsheetIntervalTimeEdit> createState() =>
      _BottomsheetIntervalTimeEditState();
}

class _BottomsheetIntervalTimeEditState
    extends State<BottomsheetIntervalTimeEdit> {
  int hour = 0;
  int minute = 0;
  ...
  void initState() {
    ...
    minuteController =
        FixedExtentScrollController(initialItem: (minute / 10).toInt() - 1);
  }
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildNumberPicker(
                      ...
                      onChanged: (value) {
                        setState(() {
                          minute = (value % totalMinutes + 1) *
                              10; // Cuộn vô tận cho phút
                          print(minute);
      ...
      child: ListWheelScrollView.useDelegate(
        ...
        childDelegate: ListWheelChildBuilderDelegate(
          builder: (context, index) {
            ...
            if (isHour) {
              displayValue = index % totalItems;
              isSelected = displayValue == currentValue;
            } else {
              print(index);
              displayValue = ((index + 1) % totalItems) == 0
                  ? 50
                  : ((index + 1) % totalItems) * 10;
              isSelected = displayValue == currentValue;
            }
            ...
            return Container(
              ...
              child: Text(
                "${displayValue.toString().padLeft(2, '0')} ${isHour ? "hour" : "mins"}",
                style: style,
              ),
            );
          },
